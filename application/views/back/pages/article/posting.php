<div class="container">
    ...
    <div class="row mt-3">
        <div class="col">
            <a href="<?= base_url("back/posting/create") ?>" class="btn btn-success btn-sm"><i class="fas fa-plus"></i>
                Tambah</a>
...
<!-- Modal -->
<div class="modal fade" id="modalPosting" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal" id="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <label for="choice" class="col-form-label">Rekomendasi</label>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" id="label-photo"><span class="text-danger">*</span>
                            Upload Photo </label>
                        <div class="col-sm-10">
